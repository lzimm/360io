# -*- test-case-name: hack.web2.test.test_httpauth -*-
...
from hack.web2.auth.interfaces import IAuthenticatedRequest
...
class HTTPAuthResource(object):
    ...
    def __init__(self, wrappedResource, credentialFactories,
                 portal, interfaces):
        """
        @param wrappedResource: A L{hack.web2.iweb.IResource} to be returned
