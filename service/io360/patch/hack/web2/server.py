# -*- test-case-name: hack.web2.test.test_server -*-
...
# Sibling Imports
from hack.web2 import http, iweb, fileupload, responsecode
from hack.web2 import http_headers
from hack.web2.filter.range import rangefilter
from hack.web2 import error

from hack.web2 import version as web2_version
...
def parsePOSTData(request, maxMem=100*1024, maxFields=1024,
    ...
    @type request: L{hack.web2.http.Request}.
